      ...
      <div style={{ padding: '16px' }}>
        ...
        <div style={{ position: 'relative', marginBottom: '12px' }}>
          <textarea
            ...
            style={{ width: '100%', boxSizing: 'border-box', minHeight: '90px', padding: '12px', paddingBottom: '32px', borderRadius: '16px', border: '1px solid var(--border)', outline: 'none', background: 'rgba(0,0,0,0.2)', color: 'white', resize: 'none', fontFamily: 'inherit', fontSize: '13px' }}
          />
